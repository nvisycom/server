//! Document annotation model for PostgreSQL database operations.
...
#[diesel(table_name = document_annotations)]
#[diesel(check_for_backend(diesel::pg::Pg))]
pub struct DocumentAnnotation {
    /// Unique annotation identifier.
    pub id: Uuid,
    /// Reference to the document file this annotation belongs to.
...
/// Data for creating a new document annotation.
#[derive(Debug, Clone, Insertable)]
#[diesel(table_name = document_annotations)]
#[diesel(check_for_backend(diesel::pg::Pg))]
pub struct NewDocumentAnnotation {
    /// Document file ID.
    pub document_file_id: Uuid,
    /// Account ID.
    pub account_id: Uuid,
...
/// Data for updating a document annotation.
#[derive(Debug, Clone, Default, AsChangeset)]
#[diesel(table_name = document_annotations)]
#[diesel(check_for_backend(diesel::pg::Pg))]
pub struct UpdateDocumentAnnotation {
    /// Annotation content.
...
impl HasCreatedAt for DocumentAnnotation {
    fn created_at(&self) -> jiff::Timestamp {
        self.created_at.into()
    }
}

impl HasUpdatedAt for DocumentAnnotation {
    fn updated_at(&self) -> jiff::Timestamp {
        self.updated_at.into()
    }
}

impl HasDeletedAt for DocumentAnnotation {
