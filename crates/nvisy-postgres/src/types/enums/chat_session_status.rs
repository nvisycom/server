//! Chat session status enumeration for LLM-assisted editing sessions.
...
/// Defines the lifecycle status of a chat editing session.
///
/// This enumeration corresponds to the `CHAT_SESSION_STATUS` PostgreSQL enum and is used
...
#[ExistingTypePath = "crate::schema::sql_types::ChatSessionStatus"]
...
impl ChatSessionStatus {
    ...
    pub fn is_active(self) -> bool {
        matches!(self, ChatSessionStatus::Active)
    }

    /// Returns whether the session is paused.
    #[inline]
    pub fn is_paused(self) -> bool {
        matches!(self, ChatSessionStatus::Paused)
    }

    /// Returns whether the session is archived.
    #[inline]
    pub fn is_archived(self) -> bool {
        matches!(self, ChatSessionStatus::Archived)
    }
    ...
    pub fn can_archive(self) -> bool {
        matches!(self, ChatSessionStatus::Active | ChatSessionStatus::Paused)
    }
    ...
    pub fn active_statuses() -> &'static [ChatSessionStatus] {
        &[ChatSessionStatus::Active, ChatSessionStatus::Paused]
    }
}
