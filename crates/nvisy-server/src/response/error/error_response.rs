...
impl<'a> ErrorResponse<'a> {
    ...
    ///
    /// This is the building block for [`ErrorKind::response`], the single source
    /// of truth for each kind's name, status, and message.
    ///
    /// [`ErrorKind::response`]: crate::response::ErrorKind::response
    #[inline]
