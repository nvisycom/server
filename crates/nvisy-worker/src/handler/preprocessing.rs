...
use nvisy_nats::stream::{DocumentJob, DocumentJobSubscriber, PreprocessingData, TypedMessage};
...
const TRACING_TARGET: &str = "nvisy_worker::preprocessing";
...
impl PreprocessingWorker {
    ...
    async fn handle_stream_result(
        &self,
        result: nvisy_nats::Result<Option<TypedMessage<DocumentJob<PreprocessingData>>>>,
    ) -> bool {
