...
use nvisy_nats::stream::{DocumentJob, DocumentJobSubscriber, PostprocessingData, TypedMessage};
...
impl PostprocessingWorker {
    ...
    async fn handle_stream_result(
        &self,
        result: nvisy_nats::Result<Option<TypedMessage<DocumentJob<PostprocessingData>>>>,
    ) -> bool {
