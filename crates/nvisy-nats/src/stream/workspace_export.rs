//! Workspace export job types and shared structures.
...
pub struct WorkspaceExportJob {
    pub id: Uuid,
    pub payload: WorkspaceExportPayload,
...
impl WorkspaceExportJob {
    /// Create a new workspace export job
    pub fn new(payload: WorkspaceExportPayload) -> Self {
        Self {
            id: Uuid::new_v4(),
            payload,
            ...
            max_retries: 3,
            retry_count: 0,
            timeout: Duration::from_secs(600), // 10 minutes for exports
