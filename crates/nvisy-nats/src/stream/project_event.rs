//! Project event stream for real-time WebSocket communication.
//!
//! This module provides NATS-based pub/sub for project WebSocket messages,
...
impl ProjectWsMessage {
    ...
    pub fn account_id(&self) -> Option<Uuid> {
        match self {
            ...
            Self::ProjectUpdated(e) => Some(e.updated_by),
    ...
    pub fn timestamp(&self) -> Option<Timestamp> {
        match self {
            ...
            Self::ProjectUpdated(e) => Some(e.timestamp),
    ...
    pub fn project_updated(display_name: Option<String>, updated_by: Uuid) -> Self {
        Self::ProjectUpdated(ProjectUpdatedEvent {
            display_name,
            updated_by,
            timestamp: Timestamp::now(),
        })
...
/// Project event envelope for NATS publishing.
///
...
impl ProjectEvent {
    ...
    pub fn new(project_id: Uuid, message: ProjectWsMessage) -> Self {
        Self {
            project_id,
            message,
