...
CREATE TYPE FILE_SOURCE AS ENUM (
    ...
    'generated'     -- File was generated by the system
);
...
CREATE TABLE document_files (
    ...
    CONSTRAINT document_files_version_number_min CHECK (version_number >= 1),
...
CREATE INDEX document_files_version_chain_idx
...
COMMENT ON COLUMN document_files.version_number IS 'Version number (1 for original, increments for new versions via parent_id chain)';
...
COMMENT ON COLUMN document_files.source IS 'How the file was created (uploaded, imported, generated)';
