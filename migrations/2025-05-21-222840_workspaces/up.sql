...
-- Per-workspace membership counts broken down by role.
...
COMMENT ON VIEW workspace_member_summary IS 'Summary of workspace membership statistics.';

-- Live pending invites with workspace and inviter details.
...
COMMENT ON VIEW pending_workspace_invites IS 'Active workspace invitations with workspace and inviter details.';

-- Mark past-due pending invites as expired; returns the count updated.
