...
-- Currently active runs with elapsed duration, newest first.
...
COMMENT ON VIEW active_workspace_pipeline_runs IS 'Currently active pipeline runs with progress information.';

-- Finished runs with total duration, most recently completed first.
...
COMMENT ON VIEW workspace_pipeline_run_history IS 'Completed pipeline runs for history and analytics.';
