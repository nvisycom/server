...
ALTER TYPE ACTIVITY_TYPE ADD VALUE IF NOT EXISTS 'provider.created';
ALTER TYPE ACTIVITY_TYPE ADD VALUE IF NOT EXISTS 'provider.updated';
ALTER TYPE ACTIVITY_TYPE ADD VALUE IF NOT EXISTS 'provider.deleted';

ALTER TYPE WEBHOOK_EVENT ADD VALUE IF NOT EXISTS 'provider.created';
ALTER TYPE WEBHOOK_EVENT ADD VALUE IF NOT EXISTS 'provider.updated';
ALTER TYPE WEBHOOK_EVENT ADD VALUE IF NOT EXISTS 'provider.deleted';
